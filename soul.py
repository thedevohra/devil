...
FORWARD_CHANNEL_ID = ---1002177907947
CHANNEL_ID = ---1002177907947
error_channel_id = ---1002177907947
...
bot = telebot.TeleBot('7308591011:AAGdDwJ1oLdnkLHwPDyQnaBaFBHB7DI-y8E')
REQUEST_INTERVAL = 5
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/devilllclan *", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Contact admin @d3villlxx*", parse_mode='Markdown')
    else:
